...
const AllJob = () => {
    ...
    return (
        ...
        <div>
            <div className="p-6 py-12 dark:bg-violet-600 dark:text-gray-50" style={{ backgroundImage: "url('https://i.ibb.co/3y9zNL5/pexels-photo-796602.webp') ", backgroundRepeat: "no-repeat", backgroundSize: "cover", width: "100%", height: "300px", }}>
            ...
            <section className="p-6 dark:bg-sky-50 dark:text-sky-700">
                <div className="container p-4 mx-auto text-center">
                    <h2 className="text-4xl text-sky-700 font-bold">Trusted by the industry leaders</h2>
                </div>
